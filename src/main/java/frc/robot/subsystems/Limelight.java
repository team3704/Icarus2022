...
public class Limelight extends SubsystemBase {
    ...
    public final NetworkTableEntry angle_h  = nt.getEntry("tx"); // target offset angle horozontal
    public final NetworkTableEntry angle_v  = nt.getEntry("ty"); // target offset angle vertical
    public final NetworkTableEntry area     = nt.getEntry("ta"); // target area
    public final NetworkTableEntry skew     = nt.getEntry("ts"); // target skew
